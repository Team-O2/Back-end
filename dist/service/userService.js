...
const getMypageInfo = (userID) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const shareTogether = yield Concert_1.default.find({ user: userID }, { _id: true, title: true });
    // 현재 작성 완료 개수
    const userRM = yield Challenge_1.default.find({ user: userID }, { generation: user.generation }).count();
    ...
    // 현재기수 참여
        ...
        const term = yield date_1.period(admin.challengeStartDT, admin.challengeEndDT);
